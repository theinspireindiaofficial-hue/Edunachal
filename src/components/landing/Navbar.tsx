      ...
      <div className="container">
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Button variant="ghost" className="text-foreground hover:bg-white/5 rounded-full">Sign in</Button>
            <Button className="btn-glow rounded-full px-5 text-white border-0">Enroll Now</Button>
          </div>
          ...
          {open && (
            ...
            >
              <ul className="flex flex-col">
                ...
                <li className="mt-2"><Button className="btn-glow w-full rounded-full text-white border-0">Enroll Now</Button></li>
              </ul>
            </motion.div>
          )}
        </AnimatePresence>
