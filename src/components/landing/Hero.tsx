...
import { ArrowRight, PlayCircle, TrendingUp, Trophy, Flame, Target } from "lucide-react";
import { Button } from "@/components/ui/button";

const Hero = () => {
  return (
    <section id="home" className="relative pt-36 md:pt-44 pb-24 overflow-hidden">
      {/* Background mesh */}
      ...
      {/* Floating blobs */}
      <div aria-hidden className="absolute -top-24 -left-24 w-[28rem] h-[28rem] rounded-full bg-primary/30 blur-[120px] animate-float-slow" />
      <div aria-hidden className="absolute top-40 -right-24 w-[26rem] h-[26rem] rounded-full bg-secondary/25 blur-[120px] animate-float-slow" style={{ animationDelay: "2s" }} />
      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              <span className="px-2 py-0.5 rounded-full bg-gradient-primary text-white text-[10px] font-semibold tracking-wide">NEW</span>
              India&apos;s most loved learning OS for serious aspirants
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-display mt-6 text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.05] tracking-tight"
            >
              <span className="text-gradient">Crack competitive exams with</span>{" "}
              <span className="text-gradient-brand">precision &amp; confidence</span>
            </motion.h1>
            ...
            >
              Structured mentorship, smart strategies, world-class faculty, and a modern learning
              ecosystem engineered for top results — built for the next generation of aspirants.
            </motion.p>
            ...
            >
              <Button size="lg" className="btn-glow rounded-full text-base px-7 h-12 text-white border-0">
              ...
              <Button size="lg" variant="ghost" className="rounded-full h-12 px-6 glass hover:bg-white/10 text-foreground">
                <PlayCircle className="w-5 h-5 mr-1" /> Explore Courses
              </Button>
            </motion.div>
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className={`w-9 h-9 rounded-full ring-2 ring-background bg-gradient-to-br ${
                    i % 2 ? "from-primary to-secondary" : "from-secondary to-accent"
                  }`} />
                ))}
              </div>
              <div>
                <div className="text-foreground font-semibold">10,000+ aspirants</div>
                <div className="text-xs">already learning the smarter way</div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative">
              <div aria-hidden className="absolute -inset-6 bg-gradient-primary opacity-30 blur-3xl rounded-[3rem]" />
              <div className="relative glass-strong ring-grad rounded-3xl p-5 shadow-soft">
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                  ...
                  <Stat icon={<Trophy className="w-4 h-4" />} label="Predicted Rank" value="AIR 318" tint="from-primary/20 to-primary/5" />
                </div>
              ...
              <motion.div
                ...
                className="absolute -left-6 bottom-10 glass-strong rounded-2xl px-4 py-3 flex items-center gap-3 shadow-soft"
              >
