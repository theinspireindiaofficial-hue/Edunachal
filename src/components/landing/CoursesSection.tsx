          ...
          {courses.map((c, i) => (
            ...
            >
              <Link to={`/courses/${c.slug}`} className="block">
                <div aria-hidden className="absolute -top-20 -right-20 w-48 h-48 rounded-full bg-primary/12 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
